	...
	<el-dialog :title="titleType" v-model="visiable" class="new-org-dialog">
        ...
        <el-form v-if="type" :model="studentform" ref="studentform" :rules="studentrules" class="new-org-form clearfix">
            ...
            <el-form-item label="出生日期" class="item-2 l-pos">
            	 <el-date-picker type="date" :picker-options="pickerOptions"  placeholder="请选择日期" v-model="studentform.birthday"></el-date-picker>
            </el-form-item>          
...
<script>
	...
	import {saveAdd, getOrgDetail, saveEditMy} from '../request';
	import $ from 'jquery';
	let options = config();
	export default {
		props: {
